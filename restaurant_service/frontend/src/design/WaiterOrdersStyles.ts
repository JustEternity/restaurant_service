...
const styles = StyleSheet.create({
  ...
  totalContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 0, paddingTop: 16, borderTopWidth: 1, borderTopColor: '#eee' },
  ...
  editOrderButton: { backgroundColor: '#007AFF', borderRadius: 15, paddingVertical: 12, alignItems: 'center', justifyContent: 'center', minWidth: 60, height: 48, },
